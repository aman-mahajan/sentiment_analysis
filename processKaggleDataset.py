...
def load_bin_vec(fname, vocab):
    ...
    with open(fname, 'rb') as f:
        header = f.readline()
        vocab_size, layer1_size = map(int, header.split())  # vocab_size = 3 million, layer1size = 300
...
cPickle.dump([revs, W, word_idx_map, vocab], open('rt-train-val-test.pickle', 'wb'))
